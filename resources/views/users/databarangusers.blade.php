...
<div class="card mt-2">
  ...
  <div class="card-body">
    <form action="{{url('users/peminjamanusers')}} " method="POST">
  <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>
                ...
                <td align="center">
                  <a class="btn btn-sm btn-primary" href="{{ url('users/peminjamanusers', $data->id_barang) }}"><i class="fa fa-cart-arrow-down"> PINJAM</i></a>
                </td>
            </tr>
          @endforeach
        </tbody>
