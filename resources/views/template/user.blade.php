 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <div class="sidebar">
     ...
     <div class="user-panel mt-3 pb-3 mb-3 d-flex">
       ...
       <div class="info">
        <a href="{{ url('user/profiluser') }}" class="d-block" ><?=nama_user()->nama_user?></a>
      </div>
    </div>
    @php
       ...
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         <!-- Add icons to the links using the .nav-icon class
          ...
          <li class="nav-item has-treeview">
            <a href="{{ url('user/databaranguser') }}" class="nav-link {{ $active == 'databaranguser' ? 'active' : null}}">
          ...
          <li class="nav-item has-treeview">
            <a href="{{url('user/laporanuser')}}" class="nav-link {{ $active == 'laporanuser' ? 'active' : null}}">
