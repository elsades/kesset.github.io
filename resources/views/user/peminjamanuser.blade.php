...
<div class="card mt-2">
  ...
  <div class="card-body">
    <form action="{{url('user/peminjamanuser')}}" method="POST" autocomplete="off">
      @csrf
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label for="">ID Peminjam</label>
            <input class="form-control form-control-sm  "  value="{{ $login->id_login}}" name="id_peminjam" id="id_peminjam" {{ old('id_peminjam')}} cols="50" rows="3" readonly></input>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <a class="btn btn-sm btn-secondary" href="{{ url('user/databaranguser') }}"><i class="fa fa-chevron-left"></i> KEMBALI </a>
          </div>
      </div>
    </form>
  </div>
